...
This graph shows the relationship between the global subjectivity and rate of positive words.  Their is a positive correlation between the variables that increases at a decreasing rate then starts to decline, suggesting that the rate of positive words is highest when global subjectivity is .75.
...
The best model out of the 4 that were tested was `r bestModel$model` with an RMSE of `r round(bestModel$RMSE, 2)`.
